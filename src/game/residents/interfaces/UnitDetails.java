...
public class UnitDetails extends JPanel {
	...
	public UnitDetails(TileResident resident) {
		...
		JLabel speedLabel = new JLabel(Integer.toString(resident.moveRange()) + " Speed", SwingConstants.CENTER);
		speedLabel.setOpaque(true);
		speedLabel.setBackground(new Color(96, 220, 255));
		speedLabel.setFont(new Font("Helvetica", Font.PLAIN, 20));
		speedLabel.setBounds((Sidebar.width - 110) / 2, 140, 110, 30);
		speedLabel.setVerticalTextPosition(AbstractButton.CENTER);
		...
		rangeLabel.setBounds((Sidebar.width - 110) / 2, 175, 110, 30);
		...
		attackLabel.setBounds((Sidebar.width - 110) / 2, 210, 110, 30);
