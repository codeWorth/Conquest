...
import game.residents.OverTimeEffects.FireDoT;
import game.residents.interfaces.units.OTUnitDetails;

public class Fire_Mage extends TileUnitResident {

	public int fireDoT = 1;
	public int duration = 3;
	
	public Fire_Mage(PlayerData playerData) {
		super(playerData, 3, "fire_mage.bmp");
	}
	...
	public void attack(TileResident other) {
		...
		new FireDoT(duration, fireDoT, other); //the DoT adds itself boi ;)
